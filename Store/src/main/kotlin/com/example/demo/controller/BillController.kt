...
class BillController {
    ...
    var file = File("D:\\Documents\\Kotlin Projects\\Store\\fileBase\\bill.txt")

    fun insert(id : Int, storeId : Int, employeeId : String, clientId : String, detailID : Int, price : Float) : Boolean{
        return if (exists(id)){
            false
        }else{
            file.appendText("$id,$storeId,$employeeId,$clientId,$detailID,$price${System.getProperty("line.separator")}")
            true
        }
    }
