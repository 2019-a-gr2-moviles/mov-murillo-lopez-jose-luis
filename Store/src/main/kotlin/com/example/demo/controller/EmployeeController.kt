...
class EmployeeController {
    ...
    var file = File("D:\\Documents\\Kotlin Projects\\Store\\fileBase\\employee.txt")
    ...
    fun insert(id : String, firstName : String, lastName : String, gender : String, age : Int, phoneNumber : String, address : String, charge : String, reportsTo : String, bankAccount : String) : Boolean{
        return if (exists(id)){
            ...
            file.appendText("$id,$firstName,$lastName,$gender,$age,$phoneNumber,$address,$charge,$reportsTo,$bankAccount${System.getProperty("line.separator")}")
            true
        }
    }
